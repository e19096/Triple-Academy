	...
	View.prototype.bindEvents = function () {
	  ...
	  $(".cell").hover(function (event) {
	    if ($(event.currentTarget).html() === "") {
	      ...
	      while (this.game.adjacentsExist()) {
	        //adjacents.length >= 2) {
	        currentVal++;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.adjacentsExist = function () {
	  if (this.adjacentsObj[top].length > 0 || this.adjacentsObj[bottom].length > 0 || this.adjacentsObj[left].length > 0 || this.adjacentsObj[right].length > 0) {
	    return true;
	  }
	  return false;
	};
	
	Game.prototype.adjacentMatchingPositions = function (gridPos, pieceValue, dontCheck) {
